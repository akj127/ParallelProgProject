...
// pyinstaller --onefile --windowed --add-data "yolov5;yolov5" --add-data "Latest_Weights.pt;." --add-data "settings.json;." --hidden-import torch --hidden-import torchvision --hidden-import skimage AutoDetectApp.py
